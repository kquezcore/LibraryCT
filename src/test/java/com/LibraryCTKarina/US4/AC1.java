...
@Test
    ...
    CommonClass.login("https://library2.cybertekschool.com/login.html",
            "librarian21@library", "Sdet2022*");
    String expectedTitle = "Login - Library";
    String actualTitle = driver.getTitle();
    assertEquals(expectedTitle, actualTitle);
    driver.findElement(By.xpath("//a[@id='navbarDropdown']"))
            .click();//librarian click on Test Librarian21
    driver.findElement(By.xpath("//div[@class='dropdown-menu show']//a"))
            .click();//librarian click on logOut
